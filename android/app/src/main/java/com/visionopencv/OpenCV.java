...
public class OpenCV {
    ...
    static Mat imageToMat(Frame imageProxy) {
        Image.Plane[] plane = imageProxy.getImage().getPlanes();
        ...
        try {
            YuvImage yuvImage = new YuvImage(nv21, ImageFormat.NV21, imageProxy.getImage().getWidth(), imageProxy.getImage().getHeight(), null);
